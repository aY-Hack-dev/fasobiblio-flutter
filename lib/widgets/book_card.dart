                ...
                children: [
                  Expanded(
                    child: Container(
                      height: 3,
                      decoration: BoxDecoration(
                        color: book.isPremium ? AppColors.gold : AppColors.blue,
                        borderRadius: BorderRadius.circular(99),
                      ),
                    ),
                  ),
...
class _BookGridState extends State<BookGrid> {
  ...
  void didUpdateWidget(covariant BookGrid oldWidget) {
    ...
    if (oldWidget.books.length != books.length) visible = 24;
  }
      ...
      return Column(
        children: [
          GridView.builder(
            ...
            itemCount: books.length < visible ? books.length : visible,
