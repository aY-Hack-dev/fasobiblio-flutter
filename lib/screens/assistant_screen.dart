...
class _AssistantScreenState extends State<AssistantScreen> {
  ...
  Future<void> _restore() async {
    final saved = await widget.state.store.loadAssistantMemory(
    ...
    try {
      ...
      if (mounted) {
        showToast(
          ...
          friendlyFailure(
            error,
            action: 'obtenir une réponse de l’assistant',
          ),
        );
      }
    } finally {
...
class _Welcome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const suggestions = [
      'Trouve-moi un roman africain',
      'Comment fonctionne Premium ?',
      'Recommande-moi un document scientifique',
      'Quels documents me conseilles-tu pour étudier ?',
    ];
      ...
      children: [
        Center(
          child: Container(
            ...
            child: const Icon(AppIcons.bot, color: Colors.white, size: 29),
          ),
        ),
        ...
        const Text(
          'Interrogez-moi sur le catalogue, vos lectures ou le fonctionnement de Fasobiblio.',
          textAlign: TextAlign.center,
